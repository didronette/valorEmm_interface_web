...
Route::get('saisie/commandes/todo/transmise/{id}', 'ControllerCommande@setTodoTransmise')->middleware('gerant')->name('todoTransmise')->where('id', '[0-9]+'); // jout de l'information que la commande est à traiter
